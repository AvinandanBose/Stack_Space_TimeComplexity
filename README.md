...
𝒐𝒑𝒆𝒓𝒂𝒕𝒊𝒐𝒏 $𝒍𝒐𝒈_𝟐(𝒏)$ 𝒕𝒊𝒎𝒆𝒔. 𝑵𝒐𝒘,𝒍𝒆𝒕 𝒖𝒔 𝒈𝒆𝒏𝒆𝒓𝒂𝒍𝒊𝒛𝒆 𝒕𝒉𝒆
𝒅𝒊𝒔𝒄𝒖𝒔𝒔𝒊𝒐𝒏. 𝑭𝒐𝒓 `𝒏` 𝒑𝒖𝒔𝒉 𝒐𝒑𝒆𝒓𝒂𝒕𝒊𝒐𝒏𝒔 𝒘𝒆 𝒅𝒐𝒖𝒃𝒍𝒆 𝒕𝒉𝒆
𝒂𝒓𝒓𝒂𝒚 𝒔𝒊𝒛𝒆 $𝒍𝒐𝒈_𝟐(𝒏)$ 𝒕𝒊𝒎𝒆𝒔. 𝑻𝒉𝒂𝒕 𝒎𝒆𝒂𝒏𝒔, 𝒘𝒆 𝒘𝒊𝒍𝒍 𝒉𝒂𝒗𝒆
...
<h3> $𝟏+𝟐+𝟒+𝟖....+ \dfrac{𝒏}{𝟒} +  \dfrac{𝒏}{𝟐} +  𝒏 = 𝒏 + \dfrac{𝒏}{𝟐} + \dfrac{𝒏}{𝟒} +...𝟖+𝟒+𝟐+𝟏$ </h3> 
<h3> $= 𝑶(𝟐𝒏-𝒏(\dfrac{𝟏}{𝟐})^𝒏 ) = 𝑶(𝟐𝒏) = 𝑶(𝒏)$ </h3>
